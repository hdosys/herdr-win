...
or `brew install herdr` · `mise use -g herdr` · Windows: [Herdr Win setup or portable ZIP](https://github.com/hdosys/herdr-win/releases) · [upstream binaries](https://github.com/herdrdev/herdr/releases)
