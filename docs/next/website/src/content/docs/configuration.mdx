...
Herdr notifies you when a background agent needs input. Completion notifications are disabled by default. Enable them when you also want a popup and done sound after background work finishes:
